...
import entities.ClassExercicioProdutoVetor;
...
public class ProgramExercicioVetor2 {
    ...
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        ClassExercicioProdutoVetor[] vect = new ClassExercicioProdutoVetor[n];
        ...
        for (int i = 0; i < n; i++) {
            ...
            vect[i] = new ClassExercicioProdutoVetor(name, price);
        }
